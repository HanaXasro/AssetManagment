...
public class CategoryUValidator : AbstractValidator<CategoryU>
{
    private readonly ICategory _category;
    public CategoryUValidator(ICategory category) 
    {
        _category = category;
        RuleFor(o => o.Name)
        ...
        RuleFor(o => o.ParentId)
            .GreaterThanOrEqualTo(1).WithMessage("SubCategoryId must be at least 1 if provided.")
            .When(o => o.ParentId.HasValue)
            .MustAsync(async (id, cancellation) => await IsCategoryExists(id))
            .WithMessage("Category with the given SubCategoryId does not exist.");
